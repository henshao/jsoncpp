...
std::string valueToQuotedString( const char *value, std::string* document )
{
   ...
   if (strpbrk(value, "\"\\\b\f\n\r\t") == NULL && !containsControlCharacter( value ))
   {
      if (document)
      {
          document->append(QUOTE).append(value).append(QUOTE);
...
FastWriter::writeValue( const Value &value )
{
   ...
   case realValue:
      ...
      break;
   case stringValue:
      valueToQuotedString( value.asCString(), &document_ );
      break;
   case booleanValue:
